                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              height: 40,
                              child: TextFormField(
                                enabled: widget.secilihizmetler[index].ozel_hizmet.toString()=="1" ? true : false,

                                controller: hizmetAdi[index],
                                onSaved: (value) {
                                  setState(() {
                                    hizmetAdi[index].text = value!;
                                  });
      ...
      bottomNavigationBar: isloading ? SizedBox.shrink() : Container(
        ...
        child: ElevatedButton(
          onPressed: () {
            ...
            if(!formvalid)
              formWarningDialogs(context, 'UYARI', "Hizmet eklemeden önce tüm bilgilerin eksiksiz girilmesi gerekmektedir. Lütfen formu tekrar kontrol ediniz.");
            else
            {


              widget.hizmetDataGridSource.hizmetekleduzenle(widget.yeniEkleme, hizmetAdlari, widget.secilihizmetler, hizmetsureleri, hizmetfiyatlari, secilipersoneller,widget.isletmebilgi["id"].toString());
