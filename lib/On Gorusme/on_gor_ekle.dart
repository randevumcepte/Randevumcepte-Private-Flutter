...
class YeniGorusme extends StatefulWidget {
  const YeniGorusme({Key? key}) : super(key: key);

  @override
  _YeniGorusmeState createState() => _YeniGorusmeState();
}

class _YeniGorusmeState extends State<YeniGorusme> {
  TextEditingController dateInput = TextEditingController();


  final List<String> _tip = ["İnternet","Referans"];
  String? _selectedTip;



  final List<String> _hatirlatma = ["(1) gün sonra hatırlatırsın","(5) gün sonra hatırlatırsın","(10) gün sonra hatırlatırsın","(20) gün sonra hatırlatırsın"
      "(40) gün sonra hatırlatırsın","(80) gün sonra hatırlatırsın","(120) gün sonra hatırlatırsın"];
  String? _selectedHatirlatma;

  final List<String> _meslek = ["Akademisyen","Doktor",",öğretmen","Mühendis","Tercüman"];
  String? _selectedMeslek;

  final List<String> _gorusme = ["Anıl Orbey","Cevriye Efe"];
  String? _selectedGorusme;

  final List<String> _hizmet = ["Kuaförler","Berberler","Güzellik ve Estetik Merkezleri","Spalar","Solaryum Merkezleri",
    "Sağlıklı Yaşam Merkezleri","Tırnak ve Makyaj Stüdyoları","Diyetisyenler","Dövme ve Tattoo Merkezleri","Tesettür Kuaförleri"];
  String? _selectedHizmet;
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Ön Görüşme Ekle',style: TextStyle(color: Colors.black),),
    ...
    return Column(
      children: <Widget>[
          ...
          child: Center(
            child: TextField(
              ...
              decoration: InputDecoration(
                  labelText: "Tarih Gİriniz" //label text of field
              ),
              readOnly: true,
        ...
        DropdownButton<String>(
          ...
          // Customize the selected item
          selectedItemBuilder: (BuildContext context) => _hizmet
              .map((e) => Center(
            child: Text(
              e,
              style: const TextStyle(
