...
class MusteriRandevulari extends StatefulWidget {
  ...
  const MusteriRandevulari({Key? key,required this.isletmebilgi, required this.md, required this.geriButonu}) : super(key: key);
  @override
  _MusteriRandevulariMenuState createState() => _MusteriRandevulariMenuState();
}

class _MusteriRandevulariMenuState extends State<MusteriRandevulari> {
  Timer? _debounce;
