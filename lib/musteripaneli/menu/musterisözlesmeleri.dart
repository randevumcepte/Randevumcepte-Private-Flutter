...
class MusteriPaneliArsivDetay extends StatefulWidget {
  ...
  const MusteriPaneliArsivDetay({Key? key, required this.md,required this.isletmebilgi}) : super(key: key);
...
class _MusteriPaneliArsivDetayState extends State<MusteriPaneliArsivDetay> {
  ...
  Future<void> initialize() async {
    _arsivDataGridSource = ArsivDataSource2(
      ...
      musteriDanisanId: widget.md.name, musteriid: widget.md.id,
              ...
              _arsivDataGridSource.rows.isEmpty
                ...
                child: SfDataGrid(
                  ...
                  onCellTap: (DataGridCellTapDetails details) {
                    ...
                    _arsivDataGridSource.showDetailsDialog(
