...
class MusteriPaneliAdiayonlari extends StatefulWidget {
  ...
  MusteriPaneliAdiayonlari({Key? key, required this.kullanici,required this.isletmebilgi}) : super(key: key);
  @override
  _MusteriPaneliAdiayonlariState createState() => _MusteriPaneliAdiayonlariState();
}
...
class _MusteriPaneliAdiayonlariState extends State<MusteriPaneliAdiayonlari> {
  ...
  Future<void> initialize() async {
    ...
    log('işletme : '+widget.isletmebilgi.toString());
