...
class MusteriProfilBilgileri extends StatefulWidget {
  ...
  MusteriProfilBilgileri({Key? key,required this.kullanici}) : super(key: key);
  @override
                            ...
                            Form(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(widget.kullanici.cep_telefon, style: TextStyle(color: Colors.white, fontWeight: FontWeight.w400,fontSize: 14,),),
                                    SizedBox(height:15),
                                    ElevatedButton.icon(
                                      onPressed: () {
                                        Navigator.push(
