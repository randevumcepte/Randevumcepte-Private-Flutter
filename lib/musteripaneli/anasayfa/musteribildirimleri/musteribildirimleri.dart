...
import '../../../yonetici/diger/menu/randvular/randevularmenu.dart';
...
class _BildirimlerScreenState extends State<MusteriBildirimlerScreen> {
                  ...
                  child: ListTile(
                    ...
                    if (bildirimData.randevuid != "null") {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => MusteriRandevulari( isletmebilgi: widget.isletmebilgi,md:widget.md,geriButonu: true,),
                        ),
                      );
                    } if (bildirimData.randevuid == "null") {
                      String url='';
