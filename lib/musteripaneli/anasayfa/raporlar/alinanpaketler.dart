...
class _MusteriAdiayonlariState extends State<MusteriALinanPaketlerDashboard> {
      ...
      body: _isLoading
        ...
        child: CircularProgressIndicator(),
          ...
          child: Column(children: [
            _satisDataGridSource.rows.length == 0 ? Center(child: Text('Satın almış olduğunuz paket bulunmamaktadır'),) :
            Container(
              height: height - 145,
