...
class _BottomNavigationExampleState extends State<BottomNavigationExample>   {
  ...
  void initState() {
    ...
    _pages = [
      ...
      DigerPage(kullanici: widget.kullanici, uyelikturu: widget.uyelikturu, onLogout: _handleLogout, isletmebilgi: widget.isletmebilgi,dialpadManager: dialPadManager,scaffoldMessengerKey: widget.scaffoldMessengerKey,),
