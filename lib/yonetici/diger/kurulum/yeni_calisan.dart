...
class YeniCalisan extends StatefulWidget {
  final dynamic isletmebilgi;
  const YeniCalisan({Key? key,required this.isletmebilgi}) : super(key: key);

  @override
  _YeniCalisanState createState() => _YeniCalisanState();
}

class _YeniCalisanState extends State<YeniCalisan> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Yeni Çalışan',style: TextStyle(color: Colors.black),),
          actions: [
