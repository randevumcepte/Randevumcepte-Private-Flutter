...
class YeniOnGorusme extends StatefulWidget {
  ...
  const YeniOnGorusme({Key? key,required this.ongorusmedatasource,required this.isletmebilgi}) : super(key: key);
                ...
                child: DropdownButton2<Sehir>(
                  ...
                  dropdownSearchData: DropdownSearchData(
                    ...
                    searchInnerWidget: Container(
                      ...
                      child: TextFormField(
                        controller: ongorusmesehircontroller,
                        expands: true,
                        maxLines: null,
                        decoration: InputDecoration(
                          isDense: true,
                        ...
                        onChanged: (value) {
                          setState(() {}); // Force rebuild when search text changes
                        },
                      ),
                    ),
                    searchMatchFn: (item, searchValue) {
                      if (searchValue.isEmpty) return true;
                      return item.value?.sehir.toLowerCase().contains(searchValue.toLowerCase()) ?? false;
                    },
                  ),
