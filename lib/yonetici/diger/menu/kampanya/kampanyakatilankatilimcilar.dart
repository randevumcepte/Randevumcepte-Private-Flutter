...
class KatilanKampanyaKatilimci extends StatefulWidget {
	final Kampanya kampanyadetayi;
	KatilanKampanyaKatilimci({Key? key, required this.kampanyadetayi}) : super(key: key);
	@override
	_TumKampanyaKatilimciState createState() => _TumKampanyaKatilimciState();
}

class _TumKampanyaKatilimciState extends State<KatilanKampanyaKatilimci> {
	late List<dynamic> _filteredkatilimcilar = widget.kampanyadetayi.katilimcilar.where((element) => element['durum']==1).toList();
	late List<dynamic> _katilimcilar = widget.kampanyadetayi.katilimcilar.where((element) => element['durum']==1).toList();
