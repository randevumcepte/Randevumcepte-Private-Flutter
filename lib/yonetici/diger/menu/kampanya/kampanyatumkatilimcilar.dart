...
class TumKampanyaKatilimci extends StatefulWidget {
   final Kampanya kampanyadetayi;
   TumKampanyaKatilimci({Key? key, required this.kampanyadetayi}) : super(key: key);
   @override
   _TumKampanyaKatilimciState createState() => _TumKampanyaKatilimciState();
}

class _TumKampanyaKatilimciState extends State<TumKampanyaKatilimci> {
   late List<dynamic> _filteredkatilimcilar = widget.kampanyadetayi.katilimcilar;
   late List<dynamic> _katilimcilar = widget.kampanyadetayi.katilimcilar;
