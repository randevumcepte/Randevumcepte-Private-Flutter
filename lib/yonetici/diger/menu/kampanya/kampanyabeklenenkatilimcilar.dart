...
class BeklenenKampanyaKatilimci extends StatefulWidget {
	final Kampanya kampanyadetayi;
	BeklenenKampanyaKatilimci({Key? key, required this.kampanyadetayi}) : super(key: key);
	@override
	_TumKampanyaKatilimciState createState() => _TumKampanyaKatilimciState();
}

class _TumKampanyaKatilimciState extends State<BeklenenKampanyaKatilimci> {
	late List<dynamic> _filteredkatilimcilar = widget.kampanyadetayi.katilimcilar.where((element) => element['durum']==null).toList();
	late List<dynamic> _katilimcilar = widget.kampanyadetayi.katilimcilar.where((element) => element['durum']==null).toList();
