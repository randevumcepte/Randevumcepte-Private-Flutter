...
class OdenmemisSenetler extends StatefulWidget {
  @override

  _SenetlerState createState() => _SenetlerState();
}

class _SenetlerState extends State<OdenmemisSenetler> {
  ...
  Future<void> initialize() async
  {
    ...
    urunlerigetir(seciliisletme!,'1','').then((data) {
      setState(() {
        ...
        _senetDataGridSource = SenetDataSource(rowsPerPage:10,salonid: seciliisletme!,context: context,durum: 'Ödenmemiş',arama: _controller.text);
