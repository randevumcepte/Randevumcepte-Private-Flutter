...
class TumSenetler extends StatefulWidget {
  @override

  _SenetlerState createState() => _SenetlerState();
}

class _SenetlerState extends State<TumSenetler> {
  ...
  Future<void> initialize() async
  {
    seciliisletme = await secilisalonid();
      setState(() {
        _senetDataGridSource = SenetDataSource(rowsPerPage:10,salonid: seciliisletme!,context: context,durum: 'Tümü',arama: _controller.text);
