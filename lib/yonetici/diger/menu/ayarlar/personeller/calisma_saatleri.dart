...
class CalismaSaatleri extends StatefulWidget {
  ...
  const CalismaSaatleri({Key? key,required this.isletmebilgi}) : super(key: key);
...
class _CalismaSaatleriState extends State<CalismaSaatleri> {
  ...
  Future<void> initialize() async {
    ...
    final List<IsletmeCalismaSaatleri> settings = await fetchSalonHoursSettings(seciliisletme);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Çalışma Saatleri",style: TextStyle(color: Colors.black),),
      ),
      body: Padding(
...
Future<void> submitform(String salonId, calisiyor1,  calisiyor2,  calisiyor3,  calisiyor4,  calisiyor5,  calisiyor6,  calisiyor7,
  ...
  final response = await http.get(
    Uri.parse('https://apptest.randevumcepte.com.tr/api/v1/calisma_saati_guncelle_ekle/$salonId?$queryParameters'),
