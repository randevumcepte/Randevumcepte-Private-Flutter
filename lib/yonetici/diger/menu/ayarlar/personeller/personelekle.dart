              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text('Personel Adı', style: TextStyle(fontSize: 16,
                        color: Colors.black,
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 5.0),
                    child: Text('Cinsiyet', style: TextStyle(fontSize: 16,
                        color: Colors.black,
                        fontWeight: FontWeight.bold),),
                  ),
                  Row(
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 5.0),
                    child: Text('Cep telefonu', style: TextStyle(fontSize: 16,
                        color: Colors.black,
                        fontWeight: FontWeight.bold),),
                  ),
                  SizedBox(height: 10,),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 5.0),
                    child: Text('Unvan', style: TextStyle(fontSize: 16,
                        color: Colors.black,
                        fontWeight: FontWeight.bold),),
                  ),
                  SizedBox(height: 10,),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 5.0),
                    child: Text('Hesap Türü', style: TextStyle(fontSize: 16,
                        color: Colors.black,
                        fontWeight: FontWeight.bold),),
                  ),
                  const SizedBox(
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 5.0),
                    child: Text('Sabit Maaş', style: TextStyle(fontSize: 16,
                        color: Colors.black,
                        fontWeight: FontWeight.bold),),
                  ),
                  SizedBox(height: 10,),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 5.0),
                    child: Text('Hizmet Primi Hak Edişi (%)', style: TextStyle(
                        fontSize: 16,
                        color: Colors.black,
                        fontWeight: FontWeight.bold),),
                  ),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 5.0),
                    child: Text('Ürün Primi Hak Edişi (%)', style: TextStyle(
                        fontSize: 16,
                        color: Colors.black,
                        fontWeight: FontWeight.bold),),
                  ),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 5.0),
                    child: Text('Paket Primi Hak Edişi (%)', style: TextStyle(
                        fontSize: 16,
                        color: Colors.black,
                        fontWeight: FontWeight.bold),),
                  ),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 5.0),
                    child: Text('Çalışma Saatleri', style: TextStyle(fontSize: 16,
                        color: Colors.black,
                        fontWeight: FontWeight.bold),),
                  ),
                  const Divider(),
                        ...
                        child: Row(
                          children: [
                            Checkbox(
                              ...
                              // Default to false if isChecked is null
                            ...
                            if (pickedTime != null &&
                              ...
                              setState(() {
                                ...
                                baslangicsaati1.text = DateFormat.Hm().format(
                                  DateTime(
                                    2023,
                                    // You can use any year, month, and day here.
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 5.0),
                    child: Text('Personel Mola Saatleri', style: TextStyle(
                        fontSize: 16,
                        color: Colors.black,
                        fontWeight: FontWeight.bold),),
                  ),
                    ...
                    children: [
                      ElevatedButton(onPressed: () {
                        widget.personeldata.personelekleguncelle(
                          ...
                          paketprim.text,
                          seciliisletme,
                          // You need to pass the correct salonId
                          isChecked1,
                          // Checkbox states
                          isChecked2,
                          isChecked3,
