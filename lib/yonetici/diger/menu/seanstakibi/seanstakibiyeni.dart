...
import '../../../randevular/randevuduzenle.dart';
import '../ayarlar/urunler/urunduzenle.dart';


class SeansTakibi extends StatefulWidget {
  final dynamic isletmebilgi;
  SeansTakibi({Key? key,required this.isletmebilgi}) : super(key: key);
  @override
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            ElevatedButton(
                                                onPressed: () {
                                                  print('Seans randevusu '+item["randevu"].toString());
                                                  Navigator.push(context, new MaterialPageRoute(builder: (context) => RandevuDuzenle(isletmebilgi: widget.isletmebilgi, randevu: Randevu.fromJson(item["randevu"]),)));
                                                },
                                                style: ElevatedButton.styleFrom(
                                                  backgroundColor: Colors.green,
                                                  foregroundColor: Colors.white,
