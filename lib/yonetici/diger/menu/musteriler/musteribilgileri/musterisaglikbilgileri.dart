...
class MusteriSaglikBilgileri extends StatefulWidget {
  final MusteriDanisan md;
  const MusteriSaglikBilgileri({Key? key,required this.md}) : super(key: key);

  @override
  _MusteriSaglikBilgileriState createState() => _MusteriSaglikBilgileriState();
}

class _MusteriSaglikBilgileriState extends State<MusteriSaglikBilgileri> {
