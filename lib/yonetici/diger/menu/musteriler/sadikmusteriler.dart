...
class SadikMusteriler extends StatefulWidget {
  ...
  const SadikMusteriler({Key? key,required this.isletmebilgi}) : super(key: key);
  @override
...
class _MusterilerState extends State<SadikMusteriler> {
  ...
  Future<void> initialize() async
  {
    ...
    setState(() {
      ...
      _musteriDanisanDataSource = MusteriDanisanDataSource(isletmebilgi: widget.isletmebilgi,rowsPerPage:10,salonid: seciliisletme!,context: context,durum: '2',arama: _controller.text);
