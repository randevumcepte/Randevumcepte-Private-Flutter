...
class TumMusteriler extends StatefulWidget {
	...
	const TumMusteriler({Key? key,required this.isletmebilgi}) : super(key: key);
	@override
...
class _MusterilerState extends State<TumMusteriler> {
	...
	Future<void> initialize() async
	{
		...
		setState(() {
			...
			_musteriDanisanDataSource = MusteriDanisanDataSource(isletmebilgi:widget.isletmebilgi,rowsPerPage:10,salonid: seciliisletme!,context: context,durum: '3',arama: _controller.text);
