...
class TumMusteriler extends StatefulWidget {
	final dynamic isletmebilgi;
	final int kullanicirolu;
	const TumMusteriler({Key? key,required this.isletmebilgi, required this.kullanicirolu}) : super(key: key);
	@override
	_MusterilerState createState() => _MusterilerState();
}

class _MusterilerState extends State<TumMusteriler> {
	...
	Future<void> initialize() async
	{
		...
		setState(() {
			...
			_musteriDanisanDataSource = MusteriDanisanDataSource(kullanicirolu: widget.kullanicirolu, isletmebilgi:widget.isletmebilgi,rowsPerPage:10,salonid: seciliisletme!,context: context,durum: '3',arama: _controller.text);
