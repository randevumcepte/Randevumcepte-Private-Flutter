...
class HariciArsiv extends StatefulWidget {
  @override

  _ArsivState createState() => _ArsivState();
}

class _ArsivState extends State<HariciArsiv> {
  ...
  Future<void> initialize() async
  {
    ...
    _arsivDataGridSource = ArsivDataSource(cevapladi: 'null',cevapladi2: 'null', rowsPerPage:10,salonid: seciliisletme!,context: context,durum: 'null',arama: _controller.text,musteriid: "");
