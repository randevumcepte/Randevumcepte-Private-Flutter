...
class TumArsiv extends StatefulWidget {
  @override

  _TumArsivState createState() => _TumArsivState();
}

class _TumArsivState extends State<TumArsiv> {
  ...
  Future<void> initialize() async
  {
    ...
    _arsivDataGridSource = ArsivDataSource(cevapladi: '',cevapladi2: '', rowsPerPage:10,salonid: seciliisletme!,context: context,durum: '',arama: _controller.text, musteriid: '');
