...
class OnaylananArsiv extends StatefulWidget {
  @override

  _ArsivState createState() => _ArsivState();
}

class _ArsivState extends State<OnaylananArsiv> {
  ...
  Future<void> initialize() async
  {
    ...
    _arsivDataGridSource = ArsivDataSource(cevapladi: '1',cevapladi2: '1', rowsPerPage:10,salonid: seciliisletme!,context: context,durum: '1',arama: _controller.text, musteriid: '');
