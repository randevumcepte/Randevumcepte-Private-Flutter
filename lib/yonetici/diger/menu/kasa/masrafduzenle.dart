...
class MasrafDuzenle extends StatefulWidget {
    ...
    const MasrafDuzenle({Key? key,required this.personeller,required this.masrafkategorileri,required this.giderDataSource,required this.seciliisletme,required this.masraf,required this.isletmebilgi}) : super(key: key);

    @override
    _MasrafState createState() => _MasrafState();
}

class _MasrafState extends State<MasrafDuzenle> {
    ...
    late TextEditingController masrafodemeyontemcontroller = TextEditingController(text: widget.masraf.odeme_yontemi_id);
    late TextEditingController masraftarih = TextEditingController(text:widget.masraf.tarih);
    late TextEditingController tutar = TextEditingController(text: widget.masraf.tutar);
    late TextEditingController aciklama = TextEditingController(text: widget.masraf.aciklama);
    ...
    void initState() {
        super.initState();
        selectedharcayan = widget.personeller.firstWhere((element) => element.personel_adi== widget.masraf.harcayan["personel_adi"]);
        selectedmasrafkategori = widget.masrafkategorileri.firstWhere((element) => element.kategori== widget.masraf.masraf_kategorisi["kategori"]);
        selectedmasrafodemeyontem = masrafodemeyontem.firstWhere((element) => element.id == widget.masraf.odeme_yontemi_id);
    ...
    Widget build(BuildContext context) {
        ...
        return GestureDetector(
          ...
          child: MaterialApp(
              ...
              home: Scaffold(
                  appBar: new AppBar(
                      title: const Text('Masraf Düzenle',style: TextStyle(color: Colors.black),),
                ...
                Row(
                    ...
                    children: [
                        ElevatedButton(onPressed: (){
                            widget.giderDataSource.masrafEkleGuncelle(widget.masraf.id, tutar.text, selectedmasrafkategori!, aciklama.text, selectedmasrafodemeyontem!, selectedharcayan!, context,widget.seciliisletme ,masraftarih.text);
