...
class ToplamKasa extends StatefulWidget {
  ToplamKasa({Key? key}) : super(key: key);
  @override
  _ToplamKasaState createState() => _ToplamKasaState();
}

class _ToplamKasaState extends State<ToplamKasa> {
