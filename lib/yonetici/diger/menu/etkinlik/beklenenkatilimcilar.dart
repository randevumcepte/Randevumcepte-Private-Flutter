...
class BeklenenEtkinlikKatilimci extends StatefulWidget {
  ...
  BeklenenEtkinlikKatilimci({Key? key, required this.etkinlikdetayi}) : super(key: key);
  @override
  _BeklenenEtkinlikKatilimciState createState() => _BeklenenEtkinlikKatilimciState();
}

class _BeklenenEtkinlikKatilimciState extends State<BeklenenEtkinlikKatilimci> {



  late List<dynamic> _filteredkatilimcilar = widget.etkinlikdetayi.katilimcilar.where((element) => element['durum']==null).toList();
  late List<dynamic> _katilimcilar = widget.etkinlikdetayi.katilimcilar.where((element) => element['durum']==null).toList();
  ...
  void initState() {
    ...
    setState(() {
      ...
      _KatilimciDataGridSource = KatilimciDataSource(_filteredkatilimcilar,context,'null');
  ...
  void filterKatilimciData(String query, KatilimciDataSource source, List<dynamic>_katilimcilar) {
    ...
    setState(() {
      ...
      source.updateKatilimciDataSource(_filteredkatilimcilar,'null');
    });
  }
  @override
      ...
      SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Container(
              height: height-355,  // Adjust the height based on your requirements
              child: SfDataGrid(
