...
int kayitsayisi=0;
class KatilanEtkinlikKatilimci extends StatefulWidget {
  final Etkinlik etkinlikdetayi;
  KatilanEtkinlikKatilimci({Key? key, required this.etkinlikdetayi}) : super(key: key);
  @override
  _KatilanEtkinlikKatilimciState createState() => _KatilanEtkinlikKatilimciState();
}

class _KatilanEtkinlikKatilimciState extends State<KatilanEtkinlikKatilimci> {
  late List<dynamic> _filteredkatilimcilar = widget.etkinlikdetayi.katilimcilar.where((element) => element['durum']=='1').toList();
  late List<dynamic> _katilimcilar = widget.etkinlikdetayi.katilimcilar.where((element) => element['durum']=='1').toList();
  ...
  void initState() {
    ...
    setState(() {
      ...
      _KatilimciDataGridSource = KatilimciDataSource(_filteredkatilimcilar,context,'1');
  ...
  void filterKatilimciData(String query, KatilimciDataSource source, List<dynamic>_katilimcilar) {
    ...
    setState(() {
      ...
      source.updateKatilimciDataSource(_filteredkatilimcilar,'1');
    });
  }
