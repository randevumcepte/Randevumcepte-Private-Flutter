...
class KatilmayanEtkinlikKatilimci extends StatefulWidget {
  ...
  KatilmayanEtkinlikKatilimci({Key? key, required this.etkinlikdetayi}) : super(key: key);
  @override
  _TKatilmayanEtkinlikKatilimciState createState() => _TKatilmayanEtkinlikKatilimciState();
}

class _TKatilmayanEtkinlikKatilimciState extends State<KatilmayanEtkinlikKatilimci> {
  late List<dynamic> _filteredkatilimcilar = widget.etkinlikdetayi.katilimcilar.where((element) => element['durum']==0).toList();
  late List<dynamic> _katilimcilar = widget.etkinlikdetayi.katilimcilar.where((element) => element['durum']==0).toList();
