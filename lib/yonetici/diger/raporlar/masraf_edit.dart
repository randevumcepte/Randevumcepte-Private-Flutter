...
class Masrafedit extends StatefulWidget {
  final dynamic isletmebilgi;
  const Masrafedit({Key? key,required this.isletmebilgi}) : super(key: key);

  @override
  _MasrafeditState createState() => _MasrafeditState();
}

class _MasrafeditState extends State<Masrafedit> {
  final List<String> _kategori = ["Aidat","Demirbaş","Diğer","Doğalgaz","Elektrik","Firma Ödemeleri","İnternet","Kargo","Kira",
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: new AppBar(title: new Text("Masrafı Düzenle",style: TextStyle(color: Colors.black),),
