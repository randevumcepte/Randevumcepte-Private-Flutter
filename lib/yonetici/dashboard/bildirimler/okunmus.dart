...
class _BildirimPageState extends State<BildirimPage> {
  ...
  Future<List<SistemBildirimleri>> fetchData() async {
    ...
    final response = await http.get(Uri.parse('https://apptest.randevumcepte.com.tr//api/v1/bildirimgetir/114/1/'+personelid.toString()));
                    ...
                    child: ListTile(
                      leading: Image.network(
                        ...
                        errorBuilder: (BuildContext context, Object exception, StackTrace? stackTrace) {
                          return Image.asset(
                            'images/fizyofly.png', // Replace with your image path
