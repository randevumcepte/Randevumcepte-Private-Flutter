    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          behavior: SnackBarBehavior.floating,
          content: Text(
            '🎁 Kupon uygulandı: ${tutarMi ? '${tryformat.format(deger)} ₺' : (deger >= 100 ? 'Bedava' : '%${deger.toInt()}')} ${_tipAdi(tip)} indirimi (${tryformat.format(indirimTutar)} ₺)',
            style: const TextStyle(color: Colors.white),
          ),
        ),
      );
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8,),
                      // İndirim (₺) — SOL kolon (Komisyon SAG kolonda ayni satirda goruntulenir)
                      Container(
                        padding: const EdgeInsets.only(left: 8.0),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8,),
                      // Komisyon (₺) — SAG kolon (İndirim SOL kolonda ayni satirda)
                      Container(
                        padding: const EdgeInsets.only(left: 8.0),
