...
class AlacakSenetler extends StatefulWidget {
  @override
  _AlacakSenetlerState createState() => _AlacakSenetlerState();
}

class _AlacakSenetlerState extends State<AlacakSenetler> {
