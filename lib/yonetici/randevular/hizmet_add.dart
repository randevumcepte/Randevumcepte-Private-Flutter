...
class _HizmetState extends State<HizmetAdd> {
  ...
  Future<void> initialize() async
  {
    ...
    setState(() {
      ...
      log("Personel "+(widget.duzenlenecek?.personel_id?? ""));
      if(widget.duzenlenecek != null)
        secilipersonel = personelliste.firstWhere((element) => element.id.toString() == widget.duzenlenecek?.personel_id.toString() );
      isloading = false;
      if(widget.duzenlenecek != null) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text((widget.duzenlenecek != null ? "Hizmet Düzenle":"Hizmet Seç" ),style: TextStyle(color: Colors.black),),
