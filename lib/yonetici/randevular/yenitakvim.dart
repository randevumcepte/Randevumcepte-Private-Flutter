import 'yenitakvim/layout_strategy.dart';
import 'yenitakvim/tiles.dart';
import 'yenitakvim/zoom.dart';
...
class YeniTakvim extends StatefulWidget {
  const YeniTakvim({super.key});

  @override
  State<YeniTakvim> createState() => _MyHomePageState();
}
...
class _MyHomePageState extends State<YeniTakvim> {
