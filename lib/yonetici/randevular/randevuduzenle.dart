  ...
  Future<void> initialize() async {
    ...
    setState(() {
      ...
      cihazliste = isletmecihazliste;
        ...
        randevutarihi.text =
            DateFormat('yyyy-MM-dd').format(DateTime.parse(widget.randevu.tarih));
        randevusaati.text =
            DateFormat('HH:mm').format(DateTime.parse(widget.randevu.tarih));
    ...
    randevuhizmetleri.asMap().entries.forEach((element){
      ...
      suredk[element.key].text = element.value.sure_dk;
      fiyat[element.key].text = element.value.fiyat;
            ...
            child: ElevatedButton(
              onPressed: () {
                setState(() {
                  formisvalid = true;
                  String uyari =
                      'Randevuyu güncellemeden önce gerekli alanları eksiksiz doldurunuz.\n';
...
class AppointmentEditorState extends State<RandevuDuzenle> {
  ...
  String? secilimusteridanisanid;
  String? secilimusteridanisanadi;
  RandevuHizmet? secilirandevuhizmet;
  ...
  Future<void> tarihsec(BuildContext context) async {
    ...
    if (pickedDate != null) {
      ...
      print(
          formattedDate); //formatted date output using intl package =>  2021-03-16
      setState(() {
        randevutarihi.text = formattedDate; //set output date to TextField value.
      });
    } else {}
  }
  Future<void> saatsec(BuildContext context) async {
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              ListTile(
                ...
                leading: const Icon(Icons.calendar_today),
                title: Text('Tarih'),
                trailing: randevutarihi.text != '' ? Text(randevutarihi.text) : Icon(Icons.keyboard_arrow_right),
                onTap: () => tarihsec(context),
              ),
              const Divider(
                height: 1.0,
              ...
              ListTile(
                ...
                leading: const Icon(Icons.watch_later_outlined),
                title: Text('Saat'),
                trailing: randevusaati.text != '' ? Text(saatsnkaldir(randevusaati.text)) : Icon(Icons.keyboard_arrow_right),
                onTap: () => saatsec(context),
              ),
              const Divider(
                height: 1.0,
              ...
              Padding(
                ...
                child: Text('Hizmetler',style: TextStyle(fontSize: 16,color: Colors.black,fontWeight: FontWeight.bold),),
              ),
              SizedBox(height: 5),
              ...
              Padding(
                ...
                child :Text('Hizmet seçilmedi',style: TextStyle(color: Colors.red[600],fontWeight: FontWeight.bold),),
              ) :
              ...
              ListView.builder(
                  ...
                  itemBuilder: (context,index){
                    return
                      GestureDetector(
                        onTap: () {
                          log("hizmetler "+randevuhizmetleri[index].toString());

                          hizmetsec(randevuhizmetleri[index]);
                          /*ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('${randevuhizmetleri[index].hizmetler["hizmet_adi"]} düzenlenecek')),
                        );*/
                        },
                        child: Dismissible(
                            dismissThresholds: {
                            ...
                            key: Key(randevuhizmetleri[index].hizmetler["hizmet_adi"]),
                            ...
                            onDismissed: (direction) {
                              setState(() {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(content: Text('${randevuhizmetleri[index].hizmetler["hizmet_adi"]} kaldırıldı'))
                                );
                            ...
                            child : Container(
                              ...
                              child:  ListTile(
                                title: Text(randevuhizmetleri[index].hizmetler["hizmet_adi"] + " ("+randevuhizmetleri[index].personeller["personel_adi"].toString()+")"),
                                subtitle: Text('Yardımcı Personel(-ler) : '+ (getYardimciPersonel(randevuhizmetleri[index].hizmetler["id"].toString()) != ''? getYardimciPersonel(randevuhizmetleri[index].hizmetler["id"].toString()) : 'Seçilmedi') +' Cihaz : '+ (isNumeric(randevuhizmetleri[index].cihaz_id!) ? randevuhizmetleri[index].cihaz["cihaz_adi"] : 'Seçilmedi') +" Oda : "+(isNumeric(randevuhizmetleri[index].oda_id!) ? randevuhizmetleri[index].oda.toString() : 'Seçilmedi') ),
                                trailing: Text('Süre : '+randevuhizmetleri[index].sure_dk.toString() +" dk\nFiyat : "+(randevuhizmetleri[index].fiyat.toString() != "null" ? randevuhizmetleri[index].fiyat.toString() : "0,00")+" ₺"),
                              ),
                            )),
                      );
        ...
        home: Scaffold(
          bottomNavigationBar: Container(
            ...
            child:   ElevatedButton(onPressed: (){
              setState(() {
                formisvalid = true;
                String uyari = 'Randevuyu kaydetmeden önce gerekli alanları eksiksiz doldurunuz.\n';
