...
class RandevuOnay extends StatefulWidget {
  ...
  final String tarih;
  final String saat;
  RandevuOnay({Key? key,required this.seciliHizmetler,required this.tarih,required this.saat,required this.salonid}) : super(key: key);
              ...
              children: [
                TextSpan(
                  ...
                  recognizer: TapGestureRecognizer()
                    ..onTap = () async {
                      final url = Uri.parse("https://example.com/kullanim-kosullari");
                ...
                TextSpan(
                  ...
                  recognizer: TapGestureRecognizer()
                    ..onTap = () async {
                      final url = Uri.parse("https://example.com/kvkk");
                      if (await canLaunchUrl(url)) {
                        await launchUrl(url);
                      }
                    },
