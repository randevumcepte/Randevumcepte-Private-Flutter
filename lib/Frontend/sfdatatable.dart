...
import 'package:randevu_sistem/Models/alacaklarmodel.dart';
...
import 'package:randevu_sistem/yonetici/diger/menu/ajanda/ajandaduzenle.dart';
...
import 'package:randevu_sistem/yonetici/diger/menu/etkinlik/etkinikler.dart';
import 'package:randevu_sistem/yonetici/diger/menu/etkinlik/etkinlikduzenle.dart';
...
class OdaDataSource extends DataGridSource {
  ...
  Future<void> odaekle(String odaadi,String salonId,
      BuildContext context, {List<String>? personelIds, List<String>? hizmetIds, String? odaId}) async {
    final Map<String, dynamic> formData = {
      'oda_adi': odaadi,
    };
    ...
    final hizmetler = hizmetIds ?? const <String>[];
    formData['oda_hizmetleri'] = jsonEncode(hizmetler);
